...
```mermaid
gantt
    title Hoja de Ruta Go-to-Market
    dateFormat  YYYY-MM-DD
    section Fase 0 — Pre-lanzamiento
    Contacto con Bsale para marketplace     :gtm0a, 2026-06-01, 14d
    Identificar 10 agencias potenciales     :gtm0b, 2026-06-01, 14d
    Preparar landing page con trial         :gtm0c, 2026-06-01, 21d
    Unirse a comunidades online             :gtm0d, 2026-06-01, 7d
    section Fase 1 — Lanzamiento MVP
    MVP listo + primer cliente real         :gtm1a, 2026-07-01, 14d
    Publicar en grupos y comunidades        :gtm1b, 2026-07-01, 30d
    Listing en marketplace Bsale            :gtm1c, 2026-07-15, 14d
    Primeras 2 alianzas con agencias        :gtm1d, 2026-07-15, 30d
    Objetivo: 10 clientes de pago           :milestone, 2026-08-01, 0d
    section Fase 2 — Crecimiento
    Blog + SEO (primer articulo)            :gtm2a, 2026-08-01, 14d
    Programa de referidos activo            :gtm2b, 2026-08-15, 30d
    YouTube: video instalacion              :gtm2c, 2026-09-01, 14d
    Objetivo: 30 clientes de pago           :milestone, 2026-10-01, 0d
    Objetivo: 50 clientes de pago           :milestone, 2026-12-01, 0d
```
...
```mermaid
flowchart LR
    A["Visitantes\n1.000/mes"] --> B["Registros trial\n100/mes (10%)"]
    B --> C["Activan producto\n70/mes (70% de trials)"]
    C --> D["Completan primer sync\n50/mes (70% de activados)"]
    D --> E["Convierten a pago\n25/mes (50% de completados)"]
    E --> F["Retienen 3 meses\n22/mes (90% de pagos)"]
```
